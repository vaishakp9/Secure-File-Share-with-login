...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'analytical'),
		'repeat-x'  => __('Repeat Horizontally', 'analytical'),
		'repeat-y'  => __('Repeat Vertically', 'analytical'),
		'repeat'    => __('Repeat All', 'analytical'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'analytical'),
		'top center'    => __('Top Center', 'analytical'),
		'top right'     => __('Top Right', 'analytical'),
		'center left'   => __('Middle Left', 'analytical'),
		'center center' => __('Middle Center', 'analytical'),
		'center right'  => __('Middle Right', 'analytical'),
		'bottom left'   => __('Bottom Left', 'analytical'),
		'bottom center' => __('Bottom Center', 'analytical'),
		'bottom right'  => __('Bottom Right', 'analytical')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'analytical'),
		'fixed'  => __('Fixed in Place', 'analytical')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __('Normal', 'analytical'),
		'italic'      => __('Italic', 'analytical'),
		'bold'        => __('Bold', 'analytical'),
		'bold italic' => __('Bold Italic', 'analytical')
		);
