	...
	<div class="content_wrap">
		...
		<div id="content">
			<h2 class="entry-title"><a>
				<?php printf( __( 'Author Archives: %s', 'analytical' ), "<span class='vcard'><a class='url fn n' href='" . get_author_posts_url( get_the_author_meta( 'ID' ) ) . "' title='" . esc_attr( get_the_author() ) . "' rel='me'>" . get_the_author() . "</a></span>" ); ?>
			</a></h2>
			<?php if(!is_home()){
