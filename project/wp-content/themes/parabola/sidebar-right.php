		...
		<?php cryout_before_primary_widgets_hook(); ?>
			...
			<ul class="xoxo">
				...
				<li class="widget-container widget-placeholder">
					<h3 class="widget-title"><?php _e('Right Sidebar','parabola'); ?></h3>
					<p><?php
					printf( __('You currently have no widgets set in the right sidebar. You can add widgets via the <a href="%s">Dashboard</a>.','parabola'),esc_url( admin_url()."widgets.php") ); echo "<br/>";
