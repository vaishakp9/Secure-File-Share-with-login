	...
	<div id="footer-content" class="grid <?php echo $bavotasan_theme_options['width']; ?>">
		<div class="row">
			<p class="copyright c12">
				...
				<span class="credit-link fr"><i class="icon-leaf"></i><?php printf( __( 'Designed by Vaishak'), '<a href="https://themes.bavotasan.com/2013/tonic/">Themes by bavotasan.com</a>' ); ?></span>
			</p><!-- .c12 -->
		</div><!-- .row -->
