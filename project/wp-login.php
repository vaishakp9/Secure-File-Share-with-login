<?php
echo '<body background="http://www.ashwa.comuv.com/wp-content/themes/tonic/library/images/logo.png">';
/**
 * WordPress User Page
 *
...
function login_footer($input_id = '') {
	...
	if ( ! $interim_login ): ?>
	<p id="backtoblog"><a href="<?php echo esc_url(( 'ashwaracing.com/' )); ?>" target="_blank" title="<?php esc_attr_e( 'Ashwa Racing Home Page' ); ?>"><?php printf( __( '&rarr; Ashwa Racing  ' ) ); ?></a></p>
	<?php endif; ?>
...
<p id="nav">
<a href="<?php echo esc_url( wp_login_url() ); ?>"><?php _e( 'Log in' ); ?></a> |
<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>" title="<?php esc_attr_e( 'Ask for a new Password' ) ?>"><?php _e( 'Lost your password?' ); ?></a>
</p>
